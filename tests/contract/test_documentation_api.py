...
class TestDocumentationAPIContract:
    ...
    def test_get_wiki_page_markdown_contract(self, client: TestClient):
        ...
        response = client.get(f"/repositories/{repo_id}/wiki/pages/{page_id}", params=params)
    ...
    def test_documentation_endpoint_exists(self, client: TestClient, method: str, endpoint_template: str):
