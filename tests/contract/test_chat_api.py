...
class TestChatAPIContract:
    ...
    def test_stream_chat_responses_contract(self, client: TestClient):
        ...
        response = client.get(f"/repositories/{repo_id}/chat/sessions/{session_id}/stream")
    ...
    def test_get_conversation_history_contract(self, client: TestClient):
        ...
        response = client.get(f"/repositories/{repo_id}/chat/sessions/{session_id}/history")
    ...
    def test_invalid_uuid_format_chat(self, client: TestClient):
        ...
        test_cases = [
            ...
            ("GET", f"/repositories/{valid_repo_id}/chat/sessions/{invalid_session_id}"),
            ("DELETE", f"/repositories/{valid_repo_id}/chat/sessions/{invalid_session_id}"),
            ("POST", f"/repositories/{invalid_repo_id}/chat/sessions/{valid_session_id}/questions"),
            ("GET", f"/repositories/{valid_repo_id}/chat/sessions/{invalid_session_id}/stream"),
            ("GET", f"/repositories/{invalid_repo_id}/chat/sessions/{valid_session_id}/history"),
        ]
    ...
    def test_chat_endpoint_exists(self, client: TestClient, method: str, endpoint_template: str):
