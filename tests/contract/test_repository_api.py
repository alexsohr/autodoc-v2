...
class TestRepositoryAPIContract:
    ...
    def test_create_repository_contract(self, client: TestClient):
        ...
        assert data["analysis_status"] in ["pending", "processing", "completed", "failed"]
    ...
    def test_bitbucket_webhook_contract(self, client: TestClient):
        ...
        payload = {
            "repository": {
                ...
                "links": {
                    "clone": [
                        {"name": "https", "href": "https://bitbucket.org/test-org/test-repo.git"}
                    ]
                }
            }
        }
