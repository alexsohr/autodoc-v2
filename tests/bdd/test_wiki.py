"""BDD tests for wiki generation API

This module links the wiki.feature file to its step definitions.
"""
...
from tests.bdd.step_defs.wiki_steps import *  # noqa: F401, F403

# Load scenarios from feature file
scenarios("features/wiki.feature")
