...
class TestDocumentAnalysisWorkflow:
    ...
    async def test_complete_document_analysis_workflow(self, async_client: AsyncClient):
        ...
        with patch('src.services.document_service.DocumentService') as mock_service:
            ...
            mock_instance.process_file_content = AsyncMock(return_value={
    ...
    @pytest.mark.asyncio
    async def test_document_analysis_with_language_filtering(self, async_client: AsyncClient):
    ...
    @pytest.mark.asyncio
    async def test_document_analysis_with_path_pattern_filtering(self, async_client: AsyncClient):
    ...
    @pytest.mark.asyncio
    async def test_document_analysis_large_repository_handling(self, async_client: AsyncClient):
    ...
    @pytest.mark.asyncio
    async def test_document_analysis_unsupported_file_types(self, async_client: AsyncClient):
        ...
        with patch('src.services.document_service.DocumentService') as mock_service:
            ...
            def filter_supported_files(files):
                return [f for f in files if f["language"] in ["python", "markdown", "javascript"]]
            
            mock_instance.filter_supported_files = MagicMock(side_effect=filter_supported_files)
            ...
            if files_response.status_code == status.HTTP_200_OK:
                ...
                supported_languages = {"python", "markdown", "javascript", "typescript", "java", "go"}
                for file_doc in files_data["files"]:
    ...
    async def test_document_analysis_file_size_limits(self, async_client: AsyncClient):
        ...
        with patch('src.services.document_service.DocumentService') as mock_service:
            ...
            files_with_sizes = [
                ...
                {"path": "medium.py", "language": "python", "size": 512000},  # 500KB - OK
                {"path": "large.py", "language": "python", "size": 15000000},  # 15MB - Too large
                {"path": "huge.py", "language": "python", "size": 50000000},  # 50MB - Too large
            ]
    ...
    @pytest.mark.asyncio
    async def test_document_analysis_incremental_updates(self, async_client: AsyncClient):
        ...
        initial_files_response = await async_client.get(f"/repositories/{repository_id}/files")
    ...
    async def test_document_analysis_error_recovery(self, async_client: AsyncClient):
        ...
        with patch('src.services.document_service.DocumentService') as mock_service:
            ...
            analysis_response1 = await async_client.post(f"/repositories/{repository_id}/analyze")
    ...
    @pytest.mark.asyncio
    async def test_document_analysis_content_processing_quality(self, async_client: AsyncClient):
        ...
        with patch('src.services.document_service.DocumentService') as mock_service:
            ...
            mock_instance.process_file_content = AsyncMock(side_effect=mock_process_content)
