...
class WebhookValidator:
    ...
    def validate_bitbucket_signature(
        ...
        try:
            ...
            if not signature or not secret:
                logger.info("Bitbucket webhook validation skipped (no signature/secret)")
                return True
    ...
    def get_event_type_from_headers(
        ...
        try:
            ...
            if provider == WebhookProvider.GITHUB:
                ...
                logger.warning(f"Unknown provider for event type extraction: {provider}")
                return None
    ...
    def detect_provider_from_headers(self, headers: Dict[str, str]) -> Optional[WebhookProvider]:
