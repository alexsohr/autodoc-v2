...
from typing import Dict, List, Optional, Any, AsyncIterator, BinaryIO, Union
...
class StorageAdapterFactory:
    ...
    def create_adapter(cls, config: StorageConfig) -> StorageAdapter:
        ...
        """
        storage_type = config.type.value if hasattr(config.type, 'value') else str(config.type)
