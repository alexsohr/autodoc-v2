...
class CodeDocument(BaseModel):
    ...
    embedding: Optional[List[float]] = Field(default=None, description="Vector embedding (optional, stored separately)")
    ...
    def validate_file_path(cls, v: str) -> str:
        ...
        if v.startswith('/') or '..' in v:
            raise ValueError("File path must be relative to repository root and cannot contain '..'")
    ...
    def validate_language(cls, v: str) -> str:
        ...
        supported_languages = {
            ...
            'powershell', 'dockerfile', 'yaml', 'json', 'xml',
...
class CodeDocumentUpdate(BaseModel):
    ...
    processed_content: Optional[str] = Field(default=None, description="Updated processed content")
    language: Optional[str] = Field(default=None, description="Updated programming language")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Updated metadata")
    embedding: Optional[List[float]] = Field(default=None, description="Updated embedding")
...
class DocumentSearchResult(BaseModel):
    ...
    highlights: Optional[List[str]] = Field(default=None, description="Highlighted text snippets")
