...
class LLMConfig(BaseModel):
    ...
    endpoint_url: Optional[str] = Field(default=None, description="Custom endpoint (optional)")
...
class StorageConfig(BaseModel):
    ...
    connection_params: Dict[str, Any] = Field(default_factory=dict, description="Provider-specific parameters")
...
class AppConfig(BaseModel):
    ...
    llm_configs: Dict[str, LLMConfig] = Field(default_factory=dict, description="LLM provider configurations")
    default_llm_provider: Optional[str] = Field(default=None, description="Default LLM provider name")
    ...
    max_concurrent_analyses: int = Field(default=3, description="Maximum concurrent repository analyses")
    analysis_timeout_minutes: int = Field(default=30, description="Analysis timeout in minutes")
    embedding_batch_size: int = Field(default=100, description="Embedding generation batch size")
    ...
    def get_llm_config(self, provider_name: Optional[str] = None) -> Optional[LLMConfig]:
