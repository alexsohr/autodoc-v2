...
from ...models.repository import (
    Repository, RepositoryCreate, RepositoryUpdate, RepositoryResponse, RepositoryList
)
...
async def create_repository(
    ...
    try:
        ...
        if result["status"] != "success":
            ...
            elif error_type in ["InvalidURL", "ProviderDetectionFailed", "URLParsingFailed"]:
                raise HTTPException(
...
async def list_repositories(
    limit: int = Query(50, ge=1, le=100, description="Number of repositories to return"),
