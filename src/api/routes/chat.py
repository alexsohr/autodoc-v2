...
from ...models.chat import (
    QuestionRequest, QuestionAnswer, ChatSessionResponse, ChatSessionList,
    ConversationHistory, SessionStatus
)
...
@router.post("/{repository_id}/chat/sessions", response_model=ChatSessionResponse, status_code=status.HTTP_201_CREATED)
...
async def list_chat_sessions(
    repository_id: UUID,
    status_filter: Optional[str] = Query("active", description="Filter by session status"),
...
@router.get("/{repository_id}/chat/sessions/{session_id}", response_model=ChatSessionResponse)
...
@router.delete("/{repository_id}/chat/sessions/{session_id}", status_code=status.HTTP_204_NO_CONTENT)
...
@router.post("/{repository_id}/chat/sessions/{session_id}/questions", response_model=QuestionAnswer, status_code=status.HTTP_201_CREATED)
...
@router.get("/{repository_id}/chat/sessions/{session_id}/history", response_model=ConversationHistory)
