...
class ErrorHandlingMiddleware:
    ...
    async def _handle_http_exception(self, request: Request, exc: HTTPException) -> JSONResponse:
        ...
        try:
            ...
            return self._create_fallback_error_response(request, 500, "Error handling failed")
    ...
    async def _handle_validation_error(self, request: Request, exc: RequestValidationError) -> JSONResponse:
        ...
        try:
            ...
            return self._create_fallback_error_response(request, 422, "Validation error handling failed")
    ...
    async def _handle_pydantic_validation_error(self, request: Request, exc: ValidationError) -> JSONResponse:
        ...
        try:
            ...
            return self._create_fallback_error_response(request, 422, "Model validation error handling failed")
    ...
    async def _handle_general_exception(self, request: Request, exc: Exception) -> JSONResponse:
        ...
        try:
            ...
            status_code = self.error_mappings.get(exception_type, status.HTTP_500_INTERNAL_SERVER_ERROR)
            ...
            return self._create_fallback_error_response(request, 500, "Exception handling failed")
    
    def _create_fallback_error_response(self, request: Request, status_code: int, message: str) -> JSONResponse:
